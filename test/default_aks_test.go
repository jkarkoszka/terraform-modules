...
func TestDefaultAksModule(t *testing.T) {
	//given
	t.Parallel()

	tfDir := "examples/azure/default_aks"
	...
	var defaultAks DefaultAks
	terraform.OutputStruct(t, tfOptions, "default_aks", &defaultAks)

	var defaultVnet = defaultAks.DefaultVnet
